---
title: "QM 2025 Week 1:<br>Getting Started with R"
author: "Domantas Undzėnas<br>Muhammad Muhammad<br>David Grundmanns "
...
#### Get working
  7. Open the `.Rmd` file that is stored in the project (in week 1, this is called `QM2025_Week01.Rmd`).
...
The data contains yearly temperature averages of German cities as well as their geographical location (longitude and latitude). It comes from the "Deutscher Wetterdienst" and you can find it [here](https://cdc.dwd.de/portal/202204011005). Now that we have loaded the data, we can have a look at it.
